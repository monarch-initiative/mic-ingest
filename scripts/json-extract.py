...
manual_schema_map: Dict[str, dict] = {
              ...
              'nutrient_to_feature_relationships':  {'subject':'nutrient', 'object':'feature'}
              }
            ...
            for key, relationships in data["extracted_object"].items():
                ...
                if key.endswith('relationships'):
                    ...
                    for relationship in relationships:
                        ...
                        if relationship is None or required is None or not required.issubset(relationship):
                            continue
                        ...
                        # Extract labels for this specific relationship
                        ...
                        if ':' not in relationship[subject_key]:
                            ...
                            current_subject_label = entity_labels.get(relationship[subject_key])

                        if ':' not in relationship[object_key]:
                            current_object_label = relationship[object_key]
                        else:
                            current_object_label = entity_labels.get(relationship[object_key])
                        ...
                        association = Association(
                            ...
                            supporting_text=relationship.get('context'),
